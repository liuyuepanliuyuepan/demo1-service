package cn.klmb.demo.framework.sms.core.client.impl.aliyun;


import static cn.klmb.demo.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
import static cn.klmb.demo.framework.common.util.date.DateUtils.TIME_ZONE_DEFAULT;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import cn.klmb.demo.framework.common.core.KeyValue;
import cn.klmb.demo.framework.common.util.collection.MapUtils;
...
public class AliyunSmsClient extends AbstractSmsClient {
    ...
    protected void doInit() {
        IClientProfile profile = DefaultProfile.getProfile(ENDPOINT, properties.getApiKey(),
        ...
        switch (templateStatus) {
            ...
            default:
                throw new IllegalArgumentException(
                        String.format("未知审核状态(%d)", templateStatus));
        }
    }

    <T extends AcsResponse, R> SmsCommonResult<R> invoke(AcsRequest<T> request,
            Function<T, R> responseConsumer) {
        try {
            ...
            return SmsCommonResult.build(ex.getErrCode(), formatResultMsg(ex), ex.getRequestId(),
                    null, codeMapping);
        }
    }
