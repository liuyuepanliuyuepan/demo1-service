...
import static cn.klmb.demo.framework.file.core.client.s3.S3FileClientConfig.ENDPOINT_ALIYUN;
...
public class S3FileClient extends AbstractFileClient<S3FileClientConfig> {
    ...
    @Override
    public String upload(byte[] content, String path, String bizId, String type) throws Exception {
        // 执行上传
