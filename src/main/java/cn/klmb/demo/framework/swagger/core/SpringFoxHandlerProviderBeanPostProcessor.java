package cn.klmb.demo.framework.swagger.core;
...
/**
 * 解决 SpringFox 与 SpringBoot 2.6.x 不兼容的问题 该问题对应的 issue 为
...
public class SpringFoxHandlerProviderBeanPostProcessor implements BeanPostProcessor {
    ...
    private <T extends RequestMappingInfoHandlerMapping> void customizeSpringfoxHandlerMappings(
        ...
        List<T> copy = CollectionUtils.filterList(mappings,
                mapping -> mapping.getPatternParser() == null);
        // 添加到 mappings 中
        mappings.clear();
