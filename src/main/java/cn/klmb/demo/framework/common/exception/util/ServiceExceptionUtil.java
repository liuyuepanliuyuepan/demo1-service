package cn.klmb.demo.framework.common.exception.util;
 ...
 * <p>
 * 1. 异常提示信息，写在枚举类中，例如说，user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration 2.
 * 异常提示信息，写在 .properties 等等配置文件 3. 异常提示信息，写在 Apollo 等等配置中心中，从而实现可动态刷新 4. 异常提示信息，存储在 db
 * 等等数据库中，从而实现可动态刷新
 */
@Slf4j
public class ServiceExceptionUtil {
    ...
    public static String doFormat(int code, String messagePattern, Object... params) {
        ...
        for (l = 0; l < params.length; l++) {
            ...
            if (j == -1) {
                log.error("[doFormat][参数过多：错误码({})|错误内容({})|参数({})", code,
                        messagePattern, params);
                if (i == 0) {
