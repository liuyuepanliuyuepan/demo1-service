...
public interface GlobalErrorCodeConstants {
    ...
    // ========== 通用业务错误段 1000 ==========
    ErrorCode BIZ_DATA_NOT_EXISTS = new ErrorCode(1000, "数据不存在，编号【{}】");
