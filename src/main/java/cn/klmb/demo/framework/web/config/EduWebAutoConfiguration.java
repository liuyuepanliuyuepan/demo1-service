...
import cn.klmb.demo.framework.common.enums.WebFilterOrderEnum;
import cn.klmb.demo.framework.web.core.filter.CacheRequestBodyFilter;
import cn.klmb.demo.framework.web.core.filter.XssFilter;
    ...
    private void configurePathMatch(PathMatchConfigurer configurer, WebProperties.Api api) {
        ...
        configurer.addPathPrefix(api.getPrefix(),
                clazz -> clazz.isAnnotationPresent(RestController.class)
                        && antPathMatcher.match(api.getController(),
                        clazz.getPackage().getName())); // 仅仅匹配 controller 包
    }
...
//    }
    ...
    public FilterRegistrationBean<XssFilter> xssFilter(XssProperties properties,
        ...
        return createFilterBean(new XssFilter(properties, pathMatcher),
