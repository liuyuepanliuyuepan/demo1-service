...
/**
 * 短信渠道 Base VO，提供给添加、修改、详细的子 VO 使用 如果子 VO 存在差异的字段，请不要添加到这里，影响 Swagger 文档生成
 */
@Data
public class SysSmsChannelBaseVO {
    ...
    @ApiModelProperty(value = "短信 API 的账号", required = true, example = "klmb")
    ...
    @ApiModelProperty(value = "短信发送回调 URL", example = "http://www.klmb.cn")
