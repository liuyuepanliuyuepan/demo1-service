...
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_COLUMN_NOT_EXISTS;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_IMPORT_COLUMNS_NULL;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_IMPORT_TABLE_NULL;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_SYNC_NONE_CHANGE;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_TABLE_EXISTS;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_TABLE_INFO_COLUMN_COMMENT_IS_NULL;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_TABLE_INFO_TABLE_COMMENT_IS_NULL;
import static cn.klmb.demo.module.system.enums.ErrorCodeConstants.CODEGEN_TABLE_NOT_EXISTS;
...
import cn.klmb.demo.module.system.dao.codegen.CodegenColumnMapper;
import cn.klmb.demo.module.system.dao.codegen.CodegenTableMapper;
...
import cn.klmb.demo.module.system.service.codegen.inner.CodegenBuilder;
import cn.klmb.demo.module.system.service.codegen.inner.CodegenEngine;
...
public class CodegenServiceImpl implements CodegenService {
    ...
    public List<Long> createCodegenList(String userId, CodegenCreateListReqVO reqVO) {
        ...
        reqVO.getTableNames().forEach(tableName -> ids.add(createCodegen(userId, tableName)));
        return ids;
    }

    public Long createCodegen(String userId, String tableName) {
        // 从数据库中，获得数据库表结构
        TableInfo tableInfo = databaseTableService.getTable(tableName);
        // 导入
        return createCodegen0(userId, tableInfo);
    }

    private Long createCodegen0(String userId, TableInfo tableInfo) {
        // 校验导入的表和字段非空
        ...
        table.setAuthor(sysUserService.getByBizId(userId).getNickname());
    ...
    @Override
    public List<DatabaseTableRespVO> getDatabaseTableList(String name, String comment) {
        ...
        // 移除已经生成的表
        // 移除在 Codegen 中，已经存在的
        Set<String> existsTables = CollectionUtils.convertSet(codegenTableMapper.selectList(),
